  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        "heading-h7": ["18px", { lineHeight: "28px", fontWeight: "400", letterSpacing: "-1px", }],
        "heading-h6": ["22px", { lineHeight: "32px", fontWeight: "400", letterSpacing: "-1px", }],
        "heading-h5": ["24px", { lineHeight: "34px", fontWeight: "400", letterSpacing: "-1px", }],
        "heading-h4": ["32px", { lineHeight: "42px", fontWeight: "400", letterSpacing: "-1px", }],
        "heading-h3": ["36px", { lineHeight: "46px", fontWeight: "400", letterSpacing: "-1px", }],
        "heading-h2": ["42px", { lineHeight: "52px", fontWeight: "400", letterSpacing: "-1px", }],
        "heading-h1": ["72px", { lineHeight: "77px", fontWeight: "400", letterSpacing: "-1px", }],
      },
