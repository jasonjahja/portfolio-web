...
//   },
  ...
  return (
    <section
        ref={sectionRef}
        className="w-full px-25 md:px-40 xl:px-120 py-30 md:py-40 xl:py-60 flex flex-col gap-25 text-bw8 bg-[#EDEDED]"
        id="clients"
    >
      
      {/* Title */}
      <div
        className={`flex flex-col gap-5 md:gap-10 transition-all duration-700 ${
            isVisible
      ...
      {/* Grid */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-45 xl:gap-60">
