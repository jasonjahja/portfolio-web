...
export default function ProjectDetail() {
  ...
  return (
    ...
    <section ref={sectionRef} className={`${outlineStyles.page} flex flex-col items-center pt-[92px] md:pt-[107px] xl:pt-[144px] pb-30 md:pb-45 xl:pb-60 gap-25 xl:gap-45`}>
      ...
      <div className={`w-full px-25 md:px-40 xl:px-120 flex flex-col gap-30 transition-all duration-700 ${
        ...
        <div className="flex flex-col md:flex-row gap-15 md:gap-45 md:items-center items-start">
            <img src={assetUrl(cpmLogo)} alt="cpm" className="h-30 md:h-40 xl:h-45" />
    ...
    <CaseOutline contentRef={sectionRef} heroRef={imgRef} title="Centre Point Medan" pageKey="centre-point-medan" />
    </>
  );
}
